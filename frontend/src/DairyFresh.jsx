...
const GroceryEssentials = ({ addToCart }) => {
  ...
  return (
    <>
      <div className="grocery-essentials container-fluid py-4">
        <h3 className="text-center mb-3">Dairy & Fresh Foods</h3>
        <p className="text-center text-muted">
          Explore our collection of Dairy & Fresh Foods products, curated to suit your taste.
        </p>
