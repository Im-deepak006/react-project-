  ...
  return (
    <div className="return-refund-page">
      ...
      <div className="title" style={{ textAlign: 'center' }}>
        <h2><strong>Returns, Cancellations, and Refunds</strong></h2>
        <p>Home &gt; Returns, Cancellations, and Refunds</p>
      </div>

      <div className="content">
        <h2>Returns, Cancellations, and Refunds</h2>
      <p>
        If you didn’t receive a product or it is damaged, please get in touch
        with our customer support team on the same day of delivery through the
        website contact us feature or by calling us at 818181 7556 /7558. We are
        committed to your satisfaction and will gladly replace or refund any
        products that do not meet your expectations.
      </p>
      <p>
        We will send you an automated notification on our Website to confirm the
        delivery. If you receive a delivery confirmation but have not received
        your product, please contact our customer care team by phone at 818181
        7556 /7558 contact us.
      </p>
      <p>
        Our delivery agents will call on your registered phone number while
        delivering one-time orders. If you ask us to leave a delivery unattended
        at your address, you release us from any liability that may arise from
        the products being left unattended for any length of time. This includes
        risks such as theft, tampering, contamination, and changes in
        temperature for chilled or frozen items.
      </p>
      <p>
        IT IS HEREBY CLARIFIED THAT NO EXCHANGE OR RETURNS SHALL BE ACCEPTED IF
        THE PRODUCT PACKAGING IS OPENED OR PRODUCT IS USED / CONSUMED EITHER IN
        PART OR OTHERWISE.
      </p>
      <p>
        Customer can cancel the order anytime up to the cut-off time of the slot
        for which you have placed an order through the Website. Upon
        cancellation of orders we will refund any payments already made by you
        for the order.
      </p>
      <p>Customer can cancel the order within 2-3hr after placing the order.</p>
      <p>
        Upon cancellation of orders we will refund any payments already made by
        you for the order within 3-4 working days.
      </p>
      <p>
        Once the product is delivered, if any damage/return request from customer
        we will replace the product with 2 working days (No Money refund is
      ...
      <h2>General Rules</h2>
      <p>
        Users may not use the platform in order to transmit, distribute, store
        or destroy material (a) that could constitute or encourage conduct that
      ...
      <p>
        ...
        their use of sambhaar.com or their breach of the terms.
      </p>
      ...
      <p>
        ...
        including but not limited to direct / or an indirect or / and incidental
        or/and special consequential or/and exemplary damages, whether such
        interruption or/and suspension or/and termination was justified or not,
        negligent or intentional, inadvertent or advertent.
      </p>
      <p>
        User agrees that Company shall not be responsible or liable to user, or
        anyone, for the statements or conduct of any third party of the service.
        In sum, in no event shall Company’s total liability to the User for all
        damages or/and losses or/and causes of action exceed the amount paid by
        the User to Company, if any, that is related to the cause of action.
      </p>

      <h2>Shipping Policy</h2>
      <p>
        We offer delivery services within specific areas, with delivery time
        frames subject to availability. We provide delivery notifications for
        your convenience. If you encounter any delivery issues, please contact
        our customer support team. Upon delivery, please ensure someone is
        available to receive and inspect the order. We reserve the right to
        modify this policy. For more information, contact our customer support
        team.
      </p>
      ...
      <p>
        ...
        this platform be liable for any damages whatsoever (including, without
        ...
        and the platform material, whether based on warranty, contract, tort, or
